...
* 사용자 비밀번호를 변경하는 방법은 누리온에 접속 한 후 passwd 명령어를 통한 변경과 사용자 포털(www.ksc.re.kr)을 통한 변경  2가지 방법이 제공됩니다.&#x20;
  * 패스워드 변경 기간(60일)이 지나서 누리온에 접속을 못 할 경우에는 사용자 포털을 통해서 변경해야 합니다.
...
* 패스워드 변경 기간(60일)이 지났을 경우 비밀번호 변경은 사용자 포털(www.ksc.re.kr)을 통해서 가능합니다.
