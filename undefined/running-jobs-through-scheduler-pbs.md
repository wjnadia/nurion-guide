...
또한, <mark style="color:blue;">**사용자 작업은 /scratch/$USER 에서만 제출 가능합니다**</mark>.
...
<mark style="color:red;">※ 어플리케이션 PBS 옵션 추가는 주기적으로 수집된 사용자 요구에 맞추어 진행됩니다. 추가를 원하면</mark> consult@ksc.re.kr로 <mark style="color:red;">해당 어플리케이션에 대해 요청 바랍니다.</mark>
